...
/// </summary>
[PublicAPI]
public class ApiResponseNoContentResult : ApiResponseResult<object>
{
    ...
    public ApiResponseNoContentResult(ApiRequestHeaders headers)
        : base(headers, HttpStatusCode.NoContent)
