...
## ExtensionsInt32.Mai(this int, int) Method

The mai.

```csharp
public static System.DateTime Mai(this int day, int year);
```
#### Parameters

<a name='Ustilz.Extensions.Int32.ExtensionsInt32.Mai(thisint,int).day'></a>

`day` [System.Int32](https://docs.microsoft.com/en-us/dotnet/api/System.Int32 'System.Int32')

The day.

<a name='Ustilz.Extensions.Int32.ExtensionsInt32.Mai(thisint,int).year'></a>
