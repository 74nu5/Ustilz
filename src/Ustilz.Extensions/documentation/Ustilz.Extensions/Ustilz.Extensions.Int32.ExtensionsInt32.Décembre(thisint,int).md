...
## ExtensionsInt32.Décembre(this int, int) Method

The décembre.

```csharp
public static System.DateTime Décembre(this int day, int year);
```
#### Parameters

<a name='Ustilz.Extensions.Int32.ExtensionsInt32.Décembre(thisint,int).day'></a>

`day` [System.Int32](https://docs.microsoft.com/en-us/dotnet/api/System.Int32 'System.Int32')

The day.

<a name='Ustilz.Extensions.Int32.ExtensionsInt32.Décembre(thisint,int).year'></a>
