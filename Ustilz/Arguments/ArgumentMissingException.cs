namespace Ustilz.Arguments
{
    ...
    public sealed class ArgumentMissingException : Exception
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="ArgumentMissingException"/> class. Initializes a new instance of
        ///     the <see cref="T:System.Exception"/> class with a specified error message.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="ArgumentMissingException"/> class. Initializes a new instance of the<see cref="T:System.Exception"/> class with a specified error message and a
