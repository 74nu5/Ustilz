...
## ExtensionsInt32.Janvier(this int, int) Method

The janvier.

```csharp
public static System.DateTime Janvier(this int day, int year);
```
#### Parameters

<a name='Ustilz.Extensions.Int32.ExtensionsInt32.Janvier(thisint,int).day'></a>

`day` [System.Int32](https://docs.microsoft.com/en-us/dotnet/api/System.Int32 'System.Int32')

The day.

<a name='Ustilz.Extensions.Int32.ExtensionsInt32.Janvier(thisint,int).year'></a>
