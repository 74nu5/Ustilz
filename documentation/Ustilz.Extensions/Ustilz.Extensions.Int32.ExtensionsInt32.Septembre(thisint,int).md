...
## ExtensionsInt32.Septembre(this int, int) Method

The septembre.

```csharp
public static System.DateTime Septembre(this int day, int year);
```
#### Parameters

<a name='Ustilz.Extensions.Int32.ExtensionsInt32.Septembre(thisint,int).day'></a>

`day` [System.Int32](https://docs.microsoft.com/en-us/dotnet/api/System.Int32 'System.Int32')

The day.

<a name='Ustilz.Extensions.Int32.ExtensionsInt32.Septembre(thisint,int).year'></a>
